...
% =============================================================================
\section*{\color{accent}Referências bibliográficas}
...
\begin{itemize}[leftmargin=1.4em,itemsep=0.3em,topsep=0.3em]
  \item \textbf{Bresenham, J. E.} \emph{Algorithm for computer control of a digital plotter}.
        ...
        Disponível em \biblink{https://doi.org/10.1147/sj.41.0025}{doi:10.1147/sj.41.0025}.
  ...
  \item \textbf{Pitteway, M.~L.~V.} \emph{Algorithm for drawing ellipses or hyperbolae
        ...
        Disponível em \biblink{https://doi.org/10.1093/comjnl/10.3.282}{doi:10.1093/comjnl/10.3.282}.
        --- generalização do algoritmo de Bresenham para cônicas arbitrárias, base da extensão para elipses descrita na §5.
  ...
  \item \textbf{Klette, R.; Rosenfeld, A.} \emph{Digital Geometry: Geometric Methods
        ...
        --- referência padrão para topologia digital, operadores de bordo ($\partial F$), 4-/6-/26-conectividade. Usada nas §7, §12 e §18.
  ...
  \item \textbf{Foley, J.~D.; van Dam, A.; Feiner, S.~K.; Hughes, J.~F.}
        ...
        --- tratamento clássico de rasterização, modelos de iluminação, projeção perspectiva. Relevante para as §13--15.
\end{itemize}
...
\begin{itemize}[leftmargin=1.4em,itemsep=0.3em,topsep=0.3em]
  \item \textbf{Sponge Project.} \emph{Sponge Schematic Specification, version~2}.
        ...
        --- formato de arquivo \code{.schem} (gzip + NBT) que o Block Round exporta. Carregável por WorldEdit, Litematica e MCEdit.

  \item \textbf{EngineHub.} \emph{WorldEdit Documentation}.
        \biblink{https://worldedit.enginehub.org/}{worldedit.enginehub.org}.
        --- referência oficial para os comandos \cmd{//sphere}, \cmd{//hsphere}, \cmd{//ellipsoid}, \cmd{//cyl}, \cmd{//schem load} citados ao longo do documento.

  \item \textbf{Mojang AB.} \emph{Minecraft Wiki --- Inventory}.
        \biblink{https://minecraft.wiki/w/Inventory}{minecraft.wiki/w/Inventory}.
        --- referência sobre slots, stacks, baús simples (27 slots) e baús duplos (54 slots) usados na §17.
  ...
  \item \textbf{Masady} (\emph{Litematica} mod).
        ...
        --- mod do Minecraft Java Edition que importa schematics e exibe um fantasma translúcido da construção a executar.
\end{itemize}
...
\begin{itemize}[leftmargin=1.4em,itemsep=0.3em,topsep=0.3em]
  ...
  \item \textbf{Armstrong, M.~A.} \emph{Groups and Symmetry}. Undergraduate Texts in
        ...
        --- exposição introdutória ao grupo octaédrico $O_h$ e seus subgrupos, usada na §20.

  \item \textbf{Coxeter, H.~S.~M.} \emph{Regular Polytopes}. 3.\textordmasculine{} ed., Dover, 1973.
        --- referência canônica para os grupos de simetria dos sólidos regulares, incluindo o tratamento detalhado de $O_h$ de ordem 48 mencionado na §20.

  \item \textbf{Hilbert, D.; Cohn-Vossen, S.} \emph{Geometry and the Imagination}.
        AMS Chelsea, 1990 [orig.~1932].
        --- tratamento clássico de quádricas e visualização geométrica, base intuitiva da §9.
\end{itemize}
...
\begin{itemize}[leftmargin=1.4em,itemsep=0.3em,topsep=0.3em]
  \item \textbf{Cormen, T.~H.; Leiserson, C.~E.; Rivest, R.~L.; Stein, C.}
        ...
        --- análise de complexidade dos três algoritmos da §4--6, divisão com teto da §17.

  \item \textbf{Wirth, N.} \emph{Algorithms + Data Structures = Programs}.
        Prentice-Hall, 1976.
        --- exposição clássica do algoritmo de Bresenham para retas e sua extensão para circunferências.
\end{itemize}

\subsection*{Recursos online complementares}

\begin{itemize}[leftmargin=1.4em,itemsep=0.3em,topsep=0.3em]
  \item Block Round --- aplicativo: \biblink{https://vinisouza128.github.io/block-round/}{vinisouza128.github.io/block-round/}.
  \item Block Round --- repositório: \biblink{https://github.com/ViniSouza128/block-round}{github.com/ViniSouza128/block-round}.
...
\begin{itemize}[leftmargin=1.4em,itemsep=0.2em,topsep=0.3em]
  ...
  \item Documentação do WorldEdit, \biblink{https://enginehub.org/worldedit/}{enginehub.org/worldedit/} --- referência oficial dos comandos \cmd{//sphere}, \cmd{//hsphere}, \cmd{//ellipsoid}, \cmd{//copy} usados ao longo deste documento.
  \item Especificação Sponge Schematic v2, \biblink{https://github.com/SpongePowered/Schematic-Specification}{github.com/SpongePowered/Schematic-Specification} --- o formato de arquivo que o Block Round exporta como \code{.schem}.
\end{itemize}
...
O Block Round é mantido por Vinícius Rodrigues de Souza. O projeto irmão Pixel Round está disponível em \biblink{https://github.com/ViniSouza128/pixel-round}{github.com/ViniSouza128/pixel-round}; o repositório atual do Block Round está em \biblink{https://github.com/ViniSouza128/block-round}{github.com/ViniSouza128/block-round}.
