...
\begin{subfigure}[t]{0.30\linewidth}\centering
  ...
  \caption{\emph{Umbral}}
\end{subfigure}
\caption{Misma circunferencia de diámetro $D=10$ bajo los tres criterios. Cada figura muestra el conjunto de celdas marcadas por la versión correspondiente de $d_x^2+d_y^2\leq 1$, renderizada con la textura \emph{cobblestone} de Minecraft. Observa cómo varían las transiciones entre filas, las celdas de esquina y los puntos cardinales: tres respuestas matemáticamente correctas bajo criterios distintos.}
\label{fig:comp-d10}
\end{figure}
...
\begin{subfigure}[t]{0.30\linewidth}\centering
  ...
  \caption{\emph{Fino (\emph{1 vóxel})}}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.30\linewidth}\centering
  \includegraphics[width=\linewidth]{math_2d_d20_thick.png}
  \caption{\emph{Grueso}}
\end{subfigure}
\caption{Los tres modos de renderizado para la misma circunferencia euclidiana de $D=20$. El modo \emph{Fino} corresponde al borde discreto topológico ($\partial F$); el modo \emph{Grueso} añade celdas diagonales para sellar los huecos a $45^\circ$, esencial para construcciones estancas (cúpulas de Vidrio/Hielo bajo el agua).}
\label{fig:modes}
\end{figure}
...
\begin{subfigure}[t]{0.46\linewidth}\centering
  ...
  \caption{Elipsoide $W=20,\,H=10,\,D=12$.}
\end{subfigure}
\caption{Voxelización en $\mathbb{R}^3$. Cada cubo es un vóxel; su coordenada del centro $(i,j,k)$ se evalúa en la ecuación implícita $a_x^2+a_y^2+a_z^2\leq 1$. Las escaleras visibles en la superficie son consecuencia matemática de la discretización: precisamente el rasgo que da a Minecraft su identidad visual.}
\label{fig:3d-shapes}
\end{figure}
...
\begin{subfigure}[t]{0.30\linewidth}\centering
  ...
  \caption{Diagonal 50\%}
\end{subfigure}
\caption{Tres cortes sobre la misma esfera de $D=16$, cada uno conservando el 50\% del volumen. El corte $Y$ produce la cúpula clásica $V_{\mathrm{cúpula}}=\tfrac{2}{3}\pi r^3$; el diagonal expone la hipotenusa $x+y=k$ característica de ese plano de corte.}
\label{fig:cuts}
\end{figure}
...
\begin{subfigure}[t]{0.30\linewidth}\centering
  ...
  \caption{\emph{Classic} (contraste fuerte)}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.30\linewidth}\centering
  \includegraphics[width=\linewidth]{math_3d_shading_blocks.png}
  \caption{\emph{Blocks} (por defecto)}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.30\linewidth}\centering
  \includegraphics[width=\linewidth]{math_3d_shading_smooth.png}
  \caption{\emph{Smooth} (caras parecidas)}
\end{subfigure}
\caption{Tres multiplicadores de luz aplicados a las mismas tres caras visibles. \emph{Classic} ofrece el aspecto canónico de Minecraft vanilla; \emph{Smooth} reduce el contraste para superficies suaves; \emph{Blocks} es el intermedio por defecto con un retranqueo geométrico que revela las fronteras entre vóxeles aunque la textura sea la misma.}
\label{fig:shading}
\end{figure}
...
\begin{subfigure}[t]{0.40\linewidth}\centering
  ...
  \caption{Superposición \emph{OFF}}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.40\linewidth}\centering
  \includegraphics[width=\linewidth]{math_3d_overlay_on.png}
  \caption{Superposición \emph{ON} (por defecto)}
\end{subfigure}
\caption{Mismo conjunto de vóxeles con y sin el contorno negro en las aristas expuestas. Con el \emph{highlight overlay} ON, un bloque que falte en la cáscara produce una discontinuidad en el patrón que el ojo detecta de un vistazo: una herramienta de validación rápida durante la construcción en supervivencia.}
\label{fig:overlay}
\end{figure}
...
\end{subfigure}
\caption{La misma esfera de diámetro $D=8$ renderizada con tres bloques distintos. La silueta voxelizada (la matemática) es idéntica en las tres: el algoritmo elige los vóxeles; la textura es una capa puramente estética aplicada después que no altera ni el volumen ni la topología.}
\label{fig:textures}
\end{figure}
...
% =============================================================================
\section*{\color{accent}Bibliografía}
\addcontentsline{toc}{section}{Bibliografía}
\label{sec:bib}

\subsection*{Referencias técnicas (rasterización y topología digital)}
...
\begin{itemize}[leftmargin=1.4em,itemsep=0.3em,topsep=0.3em]
  \item \textbf{Bresenham, J. E.} \emph{Algorithm for computer control of a digital plotter}.
        ...
        Disponible en \biblink{https://doi.org/10.1147/sj.41.0025}{doi:10.1147/sj.41.0025}.
        --- artículo original del algoritmo del punto medio entero tratado en §5.
  ...
  \item \textbf{Pitteway, M.~L.~V.} \emph{Algorithm for drawing ellipses or hyperbolae
        ...
        Disponible en \biblink{https://doi.org/10.1093/comjnl/10.3.282}{doi:10.1093/comjnl/10.3.282}.
        --- generalización del algoritmo de Bresenham a cónicas arbitrarias, base de la extensión a elipses descrita en §5.

  \item \textbf{Kappel, A.} \emph{An ellipse-drawing algorithm for raster displays}.
        En \emph{Fundamental Algorithms for Computer Graphics} (R.~A.~Earnshaw, ed.),
        NATO ASI Series F-17, Springer, 1985, p.~257--280.
        --- formulación por dos regiones empleada en la implementación de elipses.
  ...
  \item \textbf{Klette, R.; Rosenfeld, A.} \emph{Digital Geometry: Geometric Methods
        ...
        --- referencia estándar para topología digital, operadores de borde ($\partial F$), 4-/6-/26-conectividad. Usada en §7, §12 y §18.

  \item \textbf{Foley, J.~D.; van Dam, A.; Feiner, S.~K.; Hughes, J.~F.}
        \emph{Computer Graphics: Principles and Practice}. 3.\textsuperscript{a} ed., Addison-Wesley, 2014.
        --- tratamiento clásico de rasterización, modelos de iluminación, proyección en perspectiva. Relevante para §13--15.
\end{itemize}

\subsection*{Especificaciones y herramientas de Minecraft referenciadas}
...
\begin{itemize}[leftmargin=1.4em,itemsep=0.3em,topsep=0.3em]
  \item \textbf{Sponge Project.} \emph{Sponge Schematic Specification, version~2}.
        ...
        --- formato de archivo \code{.schem} (gzip + NBT) que exporta Block Round. Cargable por WorldEdit, Litematica y MCEdit.

  \item \textbf{EngineHub.} \emph{WorldEdit Documentation}.
        \biblink{https://worldedit.enginehub.org/}{worldedit.enginehub.org}.
        --- referencia oficial para los comandos \cmd{//sphere}, \cmd{//hsphere}, \cmd{//ellipsoid}, \cmd{//cyl}, \cmd{//schem load} citados a lo largo del documento.

  \item \textbf{Mojang AB.} \emph{Minecraft Wiki --- Inventory}.
        \biblink{https://minecraft.wiki/w/Inventory}{minecraft.wiki/w/Inventory}.
        --- referencia sobre ranuras, pilas, cofres simples (27 ranuras) y cofres dobles (54 ranuras) usados en §17.
  ...
  \item \textbf{Mojang AB.} \emph{Minecraft Wiki --- Commands/fill, /clone}.
        ...
        --- comandos vanilla \cmd{/fill} y \cmd{/clone} citados en §17 y §20.

  \item \textbf{Masady} (\emph{Litematica} mod).
        \biblink{https://github.com/maruohon/litematica}{github.com/maruohon/litematica}.
        --- mod de Minecraft Java Edition que importa schematics y muestra un fantasma translúcido de la construcción a ejecutar.
\end{itemize}

\subsection*{Geometría, álgebra lineal y teoría de grupos}

\begin{itemize}[leftmargin=1.4em,itemsep=0.3em,topsep=0.3em]
  \item \textbf{Vinuesa, J.} \emph{Geometría Analítica}. Pirámide, 2009.
  ...
  \item \textbf{Armstrong, M.~A.} \emph{Groups and Symmetry}. Undergraduate Texts in
        ...
        --- exposición introductoria al grupo octaédrico $O_h$ y sus subgrupos, usada en §20.

  \item \textbf{Coxeter, H.~S.~M.} \emph{Regular Polytopes}. 3.\textsuperscript{a} ed., Dover, 1973.
        --- referencia canónica para los grupos de simetría de los sólidos regulares, incluyendo el tratamiento detallado de $O_h$ de orden 48 mencionado en §20.

  \item \textbf{Hilbert, D.; Cohn-Vossen, S.} \emph{Geometry and the Imagination}.
        AMS Chelsea, 1990 [orig.~1932].
        --- tratamiento clásico de cuádricas y visualización geométrica, base intuitiva de §9.
\end{itemize}

\subsection*{Algoritmos, estructuras de datos, complejidad}

\begin{itemize}[leftmargin=1.4em,itemsep=0.3em,topsep=0.3em]
  \item \textbf{Cormen, T.~H.; Leiserson, C.~E.; Rivest, R.~L.; Stein, C.}
        \emph{Introduction to Algorithms}. 4.\textsuperscript{a} ed., MIT Press, 2022.
        --- análisis de complejidad de los tres algoritmos de §4--6, división con techo de §17.

  \item \textbf{Wirth, N.} \emph{Algorithms + Data Structures = Programs}.
        Prentice-Hall, 1976.
        --- exposición clásica del algoritmo de Bresenham para rectas y su extensión a circunferencias.
\end{itemize}

\subsection*{Recursos en línea complementarios}

\begin{itemize}[leftmargin=1.4em,itemsep=0.3em,topsep=0.3em]
  \item Block Round --- aplicación: \biblink{https://vinisouza128.github.io/block-round/}{vinisouza128.github.io/block-round/}.
  \item Block Round --- repositorio: \biblink{https://github.com/ViniSouza128/block-round}{github.com/ViniSouza128/block-round}.
  \item Proyecto hermano Pixel Round (variante sin texturas de Minecraft):
        \biblink{https://github.com/ViniSouza128/pixel-round}{github.com/ViniSouza128/pixel-round}.
  \item Plan de clase en pt-BR (3.\textsuperscript{er} año de bachillerato):
...
\begin{itemize}[leftmargin=1.4em,itemsep=0.2em,topsep=0.3em]
  ...
  \item Documentación de WorldEdit, \biblink{https://enginehub.org/worldedit/}{enginehub.org/worldedit/} --- referencia oficial de los comandos \cmd{//sphere}, \cmd{//hsphere}, \cmd{//ellipsoid}, \cmd{//copy} usados a lo largo de este documento.
  \item Especificación Sponge Schematic v2, \biblink{https://github.com/SpongePowered/Schematic-Specification}{github.com/SpongePowered/Schematic-Specification} --- el formato de archivo que Block Round exporta como \code{.schem}.
\end{itemize}
...
Block Round es mantenido por Vinícius Rodrigues de Souza. El proyecto hermano Pixel Round está disponible en \biblink{https://github.com/ViniSouza128/pixel-round}{github.com/ViniSouza128/pixel-round}; el repositorio actual de Block Round está en \biblink{https://github.com/ViniSouza128/block-round}{github.com/ViniSouza128/block-round}.
