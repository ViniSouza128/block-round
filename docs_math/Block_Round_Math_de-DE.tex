...
Eine abschließende Bemerkung zur Reproduzierbarkeit: die gesamte Pipeline dieses Dokuments --- Build-Skript, Übersetzungen, LaTeX-Vorlage, Pro-Locale-Tabellen --- ist im \code{docs_math/}-Verzeichnis des Projekt-Repositorys enthalten. Erneutes Ausführen von \code{python build.py} auf einem System mit XeLaTeX/MiKTeX erzeugt dieses PDF exakt, in jeder der neun unterstützten Sprachen. Das Schwesterprojekt Pixel Round folgt der gleichen Struktur und ermöglicht den direkten Side-by-Side-Vergleich der texturierten und nicht-texturierten Varianten.
